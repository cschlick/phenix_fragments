...
from .atoms import AtomInputCCTBX, AtomInputGeo, AtomSelection
from .bonds import BondInputCCTBX, BondInputGeo, BondSelection
from .angles import AngleInputCCTBX, AngleInputGeo, AngleSelection
...
class Mol:
  ...
  def from_file_geocif(cls,file):
    ...
    mol_input = MolInputGeo(cif_dict)
    return cls(mol_input)
